...
- [Flutterando](https://www.youtube.com/user/jacobaraujo7) - Canal focado no desenvolvimento de aplicativos utilizando Flutter (SDK da Google para desenvolvimento Android, iOS, Desktop ou Web). O mesmo contém dicas e cursos rápidos de como desenvolver aplicativos com o Flutter. _Tags: `flutter`,`android`, `ios`_
